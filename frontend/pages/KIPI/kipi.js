    ...
    <div>
      ...
      <section>
        ...
        <h4>Registration is Free!</h4>
          <div>
            <button>AS PRESENTER</button>
            <button>AS PARTICIPANT</button>
          </div>
        </div>
      </section>
      ...
      <section>
        <div>
          <p>Got any questions? Click the button below to read through our Frequently Asked Questions</p>
          <button>OPEN KIPI FAQ</button>
        </div>
      </section>
